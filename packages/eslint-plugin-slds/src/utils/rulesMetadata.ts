const rulesMetadata = {
  ...
  "slds/modal-close-button-issue": {
    ...
    severityLevel: "error",
    ruleDesc: "Update component attributes or CSS classes for the modal close button to comply with the modal component blueprint.",
  },
  "slds/no-deprecated-classes-slds2": {
    name: "slds/no-deprecated-classes-slds2",
    severityLevel: "error",
    ruleDesc: "Replace classes that aren’t available with SLDS 2 classes. See lightningdesignsystem.com for more info.",
  },
  "length-zero-no-unit": {
  ...
  "slds/no-hardcoded-values-slds1": {
    name: "slds/no-hardcoded-values-slds1",
    severityLevel: "warning",
    warningMsg: "Replace the ${oldValue} static value with an SLDS 1 styling hook: ${newValue}.",
    errorMsg: "Replace the ${color} static value with an SLDS 1 styling hook: ${stylingHook}.",
  ...
  "slds/no-hardcoded-values-slds2": {
    ...
    severityLevel: "warning",
    warningMsg: "Consider replacing the ${oldValue} static value with an SLDS 2 styling hook that has a similar value: ${newValue}",
    errorMsg: "Consider replacing the ${oldValue} static value with an SLDS 2 styling hook that has a similar value: ${newValue}",
  ...
  "slds/no-slds-class-overrides": {
    ...
    severityLevel: "warning",
    warningMsg: "Overriding ${selector} isn’t supported. To differentiate SLDS and custom classes, create a CSS class in your namespace. Examples: myapp-input, myapp-button",
    errorMsg: "Overriding ${selector} isn’t supported. To differentiate SLDS and custom classes, create a CSS class in your namespace. Examples: myapp-input, myapp-button",
  ...
  "slds/no-deprecated-tokens-slds1": {
    ...
    severityLevel: "warning",
    warningMsg: "Consider removing ${oldValue} or replacing it with ${newValue}. Set the fallback to ${oldValue}. For more info, see Styling Hooks on lightningdesignsystem.com.",
    errorMsg: "Consider removing ${oldValue} or replacing it with ${newValue}. Set the fallback to ${oldValue}. For more info, see Styling Hooks on lightningdesignsystem.com.",
  ...
  "slds/lwc-token-to-slds-hook": {
    ...
    errorMsg: "The ${oldValue} design token is deprecated. Replace it with the SLDS 2 ${newValue} styling hook and set the fallback to ${oldValue}. For more info, see Global Styling Hooks on lightningdesignsystem.com.",
  ...
  "slds/no-deprecated-slds2-classes": {
    ...
    severityLevel: "warning",
    warningMsg: "Selector: ${selector} is no longer available in SLDS2. Please update to a supported selector.",
    errorMsg: "Selector: ${selector} is no longer available in SLDS2. Please update to a supported selector.",
  ...
  "slds/no-invalid-tokens": {
    ...
    severityLevel: "error",
    warningMsg: "Consider removing ${oldValue}, or updating to a design token with a corresponding value. To avoid breaking changes, replace it with ${newValue} styling hook. Set the fallback to ${oldValue}. For more info, read Design Tokens on lightningdesignsystem.com.\n\nOld Value: ${oldValue}\nNew Value: ${newValue}\n",
    errorMsg: "Consider removing ${oldValue}, or updating to a design token with a corresponding value. To avoid breaking changes, replace it with ${newValue} styling hook. Set the fallback to ${oldValue}. For more info, read Design Tokens on lightningdesignsystem.com.\n\nOld Value: ${oldValue}\nNew Value: ${newValue}\n",
  ...
  "slds/reduce-annotations": {
    ...
    severityLevel: "warning",
    warningMsg: "Remove this annotation and update the code to SLDS best practices. For help, file an issue at https://github.com/salesforce-ux/slds-linter/",
    errorMsg: "Remove this annotation and update the code to SLDS best practices. For help, file an issue at https://github.com/salesforce-ux/slds-linter/",
  ...
  "slds/no-slds-private-var": {
    ...
    severityLevel: "warning",
    warningMsg: "This styling hook is reserved for internal Salesforce use. Remove the --_slds- or –slds-s private variable within selector ${prop}. For more information, look up private CSS in lightningdesignsystem.com.",
    errorMsg: "This styling hook is reserved for internal Salesforce use. Remove the --_slds- or –slds-s private variable within selector ${prop}. For more information, look up private CSS in lightningdesignsystem.com.",
    ruleDesc: "Some SLDS styling hooks are private and reserved only for internal Salesforce use. Private SLDS styling hooks have prefixes --_slds- and --slds-s-.  For more information, look up private CSS in lightningdesignsystem.com.",
  },
  "slds/no-unsupported-hooks-slds2": {
    name: "slds/no-unsupported-hooks-slds2",
    severityLevel: "warning",
    warningMsg: "The ${token} styling hook isn’t present in SLDS 2 and there's no equivalent replacement. Remove it or replace it with a styling hook with a similar effect.",
    errorMsg: "The ${token} styling hook isn’t present in SLDS 2. Replace it with ${newToken}.",
  ...
  "slds/no-deprecated-slds-classes": {
    ...
    severityLevel: "warning",
    warningMsg: "The class ${className} is deprecated and not available in SLDS2. Please update to a supported class.",
    errorMsg: "The class ${className} is deprecated and not available in SLDS2. Please update to a supported class.",
