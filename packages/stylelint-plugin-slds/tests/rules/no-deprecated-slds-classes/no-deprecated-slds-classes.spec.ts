...
describe('slds/no-deprecated-slds-classes', () => {
  ...
  const tests = [{
    description:"Should report slds-has-icon_left-right as deprecated",
    input:'.slds-has-icon_left-right{border:0}',
    expectedMessage:'The class slds-has-icon_left-right is deprecated and not available in SLDS2. Please update to a supported class. (slds/no-deprecated-slds-classes)'
  }, {
